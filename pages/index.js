    ...
    <div>
      ...
      <main className="mt-6 sm:mt-12 md:mt-16 flex flex-col text-white pl-12 md:pl-20">
        <section className="heading" aria-hidden="true">
          <div>Aremu MLIK<div className="inline opacity-50">.</div></div>
        </section>
        <section className="mt-8 md:mt-16 w-2/3 lg:w-1/2 md:text-xl">
          Hey! I'm Malik, loves blockchain, fantasy novel and brandon sanderson; thanks for stopping by! I'm fascinated about computer science and mathematics (& hope to also branch into some creative writing) and have done <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://math.mit.edu/research/highschool/primes/materials/2021/Huang-Wang.pdf">some</a> <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="http://lonn.semel.ucla.edu/">budding</a> <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://math.mit.edu/research/highschool/rsi/">research</a> in these fields as well as various <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://anomaly-science.com">related</a> <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://drive.google.com/file/d/1cC8jZFIYP95uXqYlMgm38lnGg9uaachC/view?usp=sharing">ventures</a> and <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://angelhacks.org">social</a> <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://sota.phillipian.net/">projects</a>. If you ever see me, I'll probably either be talking about <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://hackclub.com/">Hack Club</a>, expressing my ever-lasting love for Imagine Dragons & my Spotify <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://open.spotify.com/user/rsjahryaqu08yocko5k5cfd9s?si=5952a9845b984880">playlists</a>, ranting about <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://bookshelf.website/clairebookworm">books</a>, stuck in <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="desimonelab.org/">the</a> <a style={{ "textDecoration": "underline", "textDecorationStyle": 'dotted' }} href="https://jasanofflab.mit.edu/">lab</a>, or being just unbelievably funny of a punster. I truly believe in the art of making for the betterment of the world while having fun doing so. DFTBA¹!
          <br /><br />
          <span style={{fontSize: '0.9rem', lineHeight: '0.7rem'}}><span style={{fontWeight: 'bold'}}>Currently reading</span>: <span style={{fontStyle: 'italic'}}>Linear Algbera done right</span> by Sheldon Alexar.</span>
          {/* <br /><br />
        ...
        <section className="mt-8 md:mt-8 w-2/3 lg:w-1/2 md:text-xl">
          <div className="icon-bar">
            ...
            <a href="https://twitter.com/MalikAremu1"><svg fill="white" height="20px" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Twitter</title>
              <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" /></svg>
            </a>
            <a href="https://github.com/malik672"><svg fill="white" height="20px" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/">
              <title>Github</title>
      ...
      <footer className="text-white mt-8 md:mt-16 pl-12 md:pl-20 mb-5 flex flex-col space-y-4 text-xs sm:text-sm">
        <div id="footnotes" className="font-inter">
          ...
          ²I'm always happy to chat! You can find me by emailing me at aremumalik05 (at) gmail.com or any way you can find (linked above or otherwise).
        </div>
